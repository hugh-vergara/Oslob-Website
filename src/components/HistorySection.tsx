      ...
      <div className="container mx-auto px-6 md:px-12 max-w-5xl text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-white p-8 rounded-3xl shadow-fun-soft border-2 border-oslob-blue/10"
          >
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-oslob-yellow p-8 rounded-3xl shadow-fun-soft border-2 border-oslob-blue/10"
          >
            <h4 className="text-3xl font-display font-bold text-oslob-blue mb-4">Fisheries to Eco-Tourism</h4>
            <p className="text-oslob-blue/90 leading-relaxed text-lg">
